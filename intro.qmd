---
title: "Basic data wrangling and analysis in R"
subtitle: Computational methods workshop session 1 (Feb 14th, 2025)
author:
...
Find your favorite datasets using `data()` or import your own data. Perform the basic statistic analysis as shown above (based on the research questions you are interested in).
:::
